...
Cal.Grid = class extends RC.CSS {
	constructor(p) {
		super(p)
		//this.watchProps = this.watchProps.concat(["flexDirection","flexWrap","justifyContent","alignContent","alignItems"])
		this.watchProps = ["flexDirection","flexWrap","justifyContent","alignContent","alignItems"]
...
Cal.Grid.displayName = "RC.Grid"
Cal.Grid.propTypes = Object.assign({}, Cal.Grid.propTypes, {
...
Cal.GridItem = class extends RC.CSS {
	constructor(p) {
		super(p)
...
Cal.GridItem.displayName = "RC.GridItem"
Cal.GridItem.propTypes = Object.assign({}, Cal.GridItem.propTypes, {
