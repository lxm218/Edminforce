...
IH.RC.ChatView = React.createClass({
  ...
  incrementalScroll(e) {
    ...
    this.scrollTimeout = Meteor.setTimeout(function(){
      let node = ReactDOM.findDOMNode(self.refs.container)
    ...
    if (this.data.isReady && msgsLength!=this.state.initAmount) {
      ...
      if (this.shouldScrollBottom || !this.state.isInitialized) {
        ...
        this.updateTimeout = Meteor.setTimeout(function(){
          let more = ReactDOM.findDOMNode(self.refs.moreMsgs)
  ...
  render() {
    ...
    return <div>
      <RC.Loading className="scroll absFull overflow" style={styles.chatView} loadingClasses="absFull" isReady={this.data.isReady} ref="container">
