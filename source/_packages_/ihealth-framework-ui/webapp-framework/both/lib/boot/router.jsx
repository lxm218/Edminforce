...
if (Meteor.isClient) {
  ...
  let routeHandler = function(p, args){
    let defs = {
      // Meta
      metaTitle: "Framework",
      metaDesc: "Framework documentation website.",
  ...
  WebRoutes.route("/", {
    ...
    action(p) {
      ...
      routeHandler(p, {
        metaTitle: "Bruno Web App Framework for Meteor.js and React",
        metaDescription: "Web App framework for Meteor.js and React.",
        pageTitle: "Web App Framework - Home",
        ...
        leftTmpl: null,
        rightTmpl: null,
        bodyTmpl: <App.Web.GetStarted />
      })
    }
  })

  // Components
  WebRoutes.route("/components/:slug?", {
    name: "components",
    action: function(p) {
      ...
      routeHandler(p, {
        metaTitle: "Bruno Web App Framework - Components",
        metaDescription: "Components for Bruno Web App Framework.",
        pageTitle: "Web App Framework - Components",
        ...
        leftTmpl: null,
        rightTmpl: null,
        bodyTmpl: p.slug ? <App.Layout.ComponentsPage platform={platform} slug={p.slug} /> : <App.Web.Components />
      })
    }
  })
  ...
  MobileRoutes.route("/components/:slug?", {
    ...
    action: function(p) {
      ...
      routeHandler(p, {
        ...
        leftTmpl: null,
        rightTmpl: null,
        bodyTmpl: p.slug ? <App.Layout.ComponentsPage platform={platform} slug={p.slug} /> : <App.Mobile.Components />
      })
    }
  })
