...
App.FormEx1 = App.Example(
  class extends RC.CSS {
        ...
        let code = '\
          class extends RC.CSS {@br\
            ...
            render() {@br\
              ...
              return <RC.Form onSubmit={this.submitForm.bindg(this)} ref="form">@br\
    ...
    renderExample() {
      ...
      return <RC.Form onSubmit={this.submitForm.bind(this)} onReset={this.formReset.bind(this)} ref="form">
