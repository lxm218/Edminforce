/*
* copy from https://github.com/percolatestudio/meteor-synced-cron/blob/master/synced-cron-server.js
* thanks percolatestudio/meteor-synced-cron
*
* @breif : remove some code to not insert collection
* */
SyncedCron = {
	_entries: {},
	running: false,
