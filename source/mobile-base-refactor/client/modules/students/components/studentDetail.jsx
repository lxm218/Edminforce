...
EdminForce.Components.MakeupClass = class extends RC.CSS {
    constructor(p) {
        super(p);
    ...
    render() {
        ...
        return (
            <RC.Div>
                <RC.Div style={{borderBottom:"1px solid #e0e0e0", paddingBottom:8}}><h3 style={{"textAlign": "center"}}>
                    Make up Class</h3></RC.Div>
                {
                    this.state.step == 1 ?
                        (
