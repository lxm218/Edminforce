	...
	getInitialState() {
	 ...
	 postPayment(e){
		...
		paymentInfo.createTransactionRequest.transactionRequest.payment.creditCard.cardNumber = form.creditCardNumber
	 	...
	 	paymentInfo.createTransactionRequest.billTo.firstName = form.cardHolderLastName
		paymentInfo.createTransactionRequest.billTo.lastName = form.cardHolderLastName
		paymentInfo.createTransactionRequest.billTo.address = form.street
		paymentInfo.createTransactionRequest.billTo.city = form.city
		paymentInfo.createTransactionRequest.billTo.state = form.state
		paymentInfo.createTransactionRequest.billTo.zip = form.zip
