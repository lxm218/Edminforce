...
typedef void (^DisposeAM3STotoalAlarmNum)(NSNumber *AlarmNum);
...
typedef void (^DisposeRandomNumberStr)(NSString* randomNumberStr);
...
//阶段性同步条数
typedef void (^DisposeAM3SSyncSportCountBlock)(NSNumber *sportCount);
//阶段性测试条数
typedef void (^DisposeAM3SMeasureDataBlock)(NSArray *measureDataArray);
//阶段性数据结束
typedef void (^DisposeAM3SWorkoutFinishBlock)(BOOL resetSuc);
...
@interface AM3S : NSObject{
    ...
    DisposeAM3STotoalAlarmNum _disposeAM3STotoalAlarmNum;
    ...
    DisposeRandomNumberStr _disposeRandomNumberStr;
    
    
    DisposeAM3SSyncSportCountBlock _disposeSyncSportCountBlock;
    DisposeAM3SMeasureDataBlock _disposeMeasureDataBlock;
    DisposeAM3SWorkoutFinishBlock _disposeAM3SWorkoutFinishBlock;
...
//查询用户ID
-(void)getAM3SUserID:(DisposeAM3SAskUserID)disposeAskUserID disposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;
//设置用户
-(void)commandSetAM3SUserID:(NSNumber*)userID DisposeBlock:(DisposeAM3SBlock)disposeBlock  DisposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;

//设置用户信息
-(void)commandSetAM3SUserAge:(NSNumber*)age weight:(NSNumber*)weight height:(NSNumber*)height sex:(NSNumber*)sex lengthType:(NSNumber*)lengthType activityLevel:(NSNumber*)activityLevel target:(NSNumber*)target hourType:(NSNumber*)hourType DisposeBlock:(DisposeAM3SBlock)disposeBlock  DisposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;
...
// 查询总的闹钟数量
-(void)commandQueryAlarmNum:(DisposeAM3STotoalAlarmNum)disposeAM3STotoalAlarmNum  DisposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;
...
//设置闹钟
-(void)commandSetAlarmWithAlarmID:(NSNumber*)alarmID hour:(NSNumber*)hour min:(NSNumber*)min isRepeat:(NSNumber*)isRepeat weeks:(NSArray*)weekArray isOpen:(NSNumber*)isOpen  DisposeResultBlock:(DisposeAM3SBlock)disposeBlock DisposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;

//同步运动数据
-(void)commandSynchronousActiveHistoryData:(AM3SHistoryData)AM3ShistoryData DisposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;


//同步睡眠数据
-(void)commandSynchronousSleephistoryData:(SleepHistoryData)sleepHistoryData DisposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;

//同步实时数据
-(void)commandSynchronousCurrentActiveInfo:(DisposeAM3SQueryCurrentActiveInfo) disposeQueryCurrentActiveInfo DisposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;
...
//设置时间格式
-(void)commandSetTimeFormat:(NSNumber*)timeFormat ResultBlock:(DisposeTimeFormatSetting)disposeBlock DisposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;
//设置随机数
...
//查询状态信息
-(void)CommandQueryStateInfo:(DisposeAM3SStateInfo)disposeStateInfo DisposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;

//查询电池电量
-(void)CommandQueryBattery:(DisposeAM3SBattery)disposeBattery DisposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;

//查询图片格式
-(void)commandQueryPicture:(DisposePicture)disposePicture DisposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;

//设置图片格式
-(void)commandSetPicture:(NSNumber*)picture ResultBlock:(DisposePictureSetting)disposeBlock DisposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;
...
-(void)commandResetDeviceWithAppSecret:(NSString*)AppSecret  DisposeResultBlock:(DisposeAM3SBlock)disposeBlock DisposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;

-(void)getAM3SWithAppSecret:(NSString*)AppSecret UserID:(DisposeAM3SAskUserID)disposeAskUserID disposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;

-(void)commandSetAM3SWithAppSecret:(NSString*)AppSecret UserID:(NSNumber*)userID DisposeBlock:(DisposeAM3SBlock)disposeBlock  DisposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;

//设置用户信息
-(void)commandSetAM3SWithAppSecret:(NSString*)AppSecret UserAge:(NSNumber*)age weight:(NSNumber*)weight height:(NSNumber*)height sex:(NSNumber*)sex lengthType:(NSNumber*)lengthType activityLevel:(NSNumber*)activityLevel target:(NSNumber*)target hourType:(NSNumber*)hourType DisposeBlock:(DisposeAM3SBlock)disposeBlock  DisposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;

//查询用户信息
-(void)commandQueryUserInfoWithAppSecret:(NSString*)AppSecret disposeBlock:(DisposeAM3SBlock)disposeBlock DisposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock DisposeUserInfo:(DisposeAM3SUserInfo)disposeUserInfo;

// 查询总的闹钟数量
-(void)commandQueryWithAppSecret:(NSString*)AppSecret AlarmNum:(DisposeAM3STotoalAlarmNum)disposeAM3STotoalAlarmNum  DisposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;

//查询闹钟信息
-(void)commandQueryWithAppSecret:(NSString*)AppSecret AlarmInfo:(DisposeAM3STotoalAlarmData)disposeTotoalAlarmData DisposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;

//设置闹钟
-(void)commandSetAlarmWithAppSecret:(NSString*)AppSecret AlarmID:(NSNumber*)alarmID hour:(NSNumber*)hour min:(NSNumber*)min isRepeat:(NSNumber*)isRepeat weeks:(NSArray*)weekArray isOpen:(NSNumber*)isOpen  DisposeResultBlock:(DisposeAM3SBlock)disposeBlock DisposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;

-(void)commandDeleteWithAppSecret:(NSString*)AppSecret AlarmViaID:(NSNumber *)alarmID DisposeResultBlock:(DisposeAM3SBlock)disposeBlock DisposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;

-(void)commandQueryWithAppSecret:(NSString*)AppSecret Reminder:(RemindAM3SInfo)remindInfo DisposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;

-(void)commandSetWithAppSecret:(NSString*)AppSecret ReminderDictionary:(NSDictionary *)reminderDic DisposeResultBlock:(DisposeAM3SBlock)disposeBlock DisposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;

//同步运动数据
-(void)commandSynchronousActiveWithAppSecret:(NSString*)AppSecret HistoryData:(AM3SHistoryData)AM3ShistoryData DisposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;


//同步睡眠数据
-(void)commandSynchronousSleepWithAppSecret:(NSString*)AppSecret historyData:(SleepHistoryData)sleepHistoryData DisposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;

//同步实时数据
-(void)commandSynchronousCurrentWithAppSecret:(NSString*)AppSecret ActiveInfo:(DisposeAM3SQueryCurrentActiveInfo) disposeQueryCurrentActiveInfo DisposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;

//查询时间格式
-(void)commandQueryWithAppSecret:(NSString*)AppSecret TimeFormat:(DisposeTimeFormat)disposeTimeFormat DisposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;

//设置时间格式
-(void)commandSetWithAppSecret:(NSString*)AppSecret TimeFormat:(NSNumber*)timeFormat ResultBlock:(DisposeTimeFormatSetting)disposeBlock DisposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;
//设置随机数
-(void)commandSetRandomWithAppSecret:(NSString*)AppSecret DisposeRandomNumberStr:(DisposeRandomNumberStr)disposeRandomNumberStr DisposeBlock:(DisposeRandomNumberSetting)disposeBlock DisposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;

//查询状态信息
-(void)CommandQueryWithAppSecret:(NSString*)AppSecret StateInfo:(DisposeAM3SStateInfo)disposeStateInfo DisposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;

//查询电池电量
-(void)CommandQueryWithAppSecret:(NSString*)AppSecret Battery:(DisposeAM3SBattery)disposeBattery DisposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;

//查询图片格式
-(void)commandQueryWithAppSecret:(NSString*)AppSecret Picture:(DisposePicture)disposePicture DisposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;

//设置图片格式
-(void)commandSetWithAppSecret:(NSString*)AppSecret Picture:(NSNumber*)picture ResultBlock:(DisposePictureSetting)disposeBlock DisposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;

//阶段性报告
//阶段性报告数据
-(void)commandAM3SSetWithAppSecret:(NSString*)AppSecret SyncsportCount:(DisposeAM3SSyncSportCountBlock)disposeSyncSportCount disposeMeasureData:(DisposeAM3SMeasureDataBlock)disposeMeasureData disposeFinishMeasure:(DisposeAM3SWorkoutFinishBlock)disposeFinishMeasure disposeErrorBlock:(DisposeAM3SErrorBlock)disposeErrorBlock;

-(void)commandDisAMDeviceConnect;
