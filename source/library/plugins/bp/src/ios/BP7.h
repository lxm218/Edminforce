...
@interface BP7 : NSObject{
    ...
    BlockZero _blockZero;
    BlockZeroComplete _blockZeroComplete;
 ...
 */
-(void)commandFounctionWithAppSecret:(NSString*)AppSecret Founction:(BlockDeviceFounction)founction errorBlock:(BlockError)error;
...
/*
 ...
 Return parameter:
    ...
    ‘error’: refer ‘error’ in ‘Establish measurement connection’ in BP5
 */
-(void)commandSetOfflineWithAppSecret:(NSString*)AppSecret open:(BOOL)open errorBlock:(BlockError)error;
 ...
 */
-(void)commandEnergyWithAppSecret:(NSString*)AppSecret energyValue:(BlockEnergyValue)energyValue errorBlock:(BlockError)error;
...
-(void)commandStartGetAngleWithAppSecret:(NSString*)AppSecret Angle:(BlockAngleNum)angleNum errorBlock:(BlockError)error;
//Measurement start
/*
...
-(void)commandBatchWithAppSecret:(NSString*)AppSecret UploadNum:(BlockBachCount)totalCount errorBlock:(BlockError)error;


-(void)commandBatchWithAppSecret:(NSString*)AppSecret UploaddataArray:(BlockBachArray)uploadDataArray errorBlock:(BlockError)error;
...
/*
 Return parameter:
    ...
    ‘error’: refer ‘error’ in ‘Establish measurement connection’ in BP5
 */
-(void)stopBPMeassureWithAppSecret:(NSString*)AppSecret Block:(BlockStopSuccess)success errorBlock:(BlockError)error;

-(void)commandStartMeasureWithAppSecret:(NSString*)AppSecret BlockZero:(BlockZero)blockZero BlockZeroComplete:(BlockZeroComplete)blockZeroComplete pressure:(BlockPressure)pressure xiaoboWithHeart:(BlockXioaboWithHeart)xiaobo xiaoboNoHeart:(BlockXioaboNoHeart)xiaoboNoHeart  result:(BlockMesureResult)result errorBlock:(BlockError)error;
