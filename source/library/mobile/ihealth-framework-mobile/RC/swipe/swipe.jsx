...
RC.Swipe = React.createClass({
  ...
  componentDidMount: function () {
    if (this.isMounted()) {
      this.swipe = SwipeJS(ReactDOM.findDOMNode(), this.props);
    }
  },
  ...
  render: function() {
    ...
    let bot = top = 0
    if (this.props.gNav) {
      if (this.props.gNav=="top")
        top += 50
      else if (this.props.gNav=="bot")
        bot += 50
    }
    ...
    return <div {... this.props} style={styles.root}>
    ...
    //         ref: child.props.ref,
    //         key: child.props.key,
    //         style: child.props.style ? assignClone(child.props.style,styles.child) : styles.child
    //       });
    //     })
    //   )
    // );
...
//   componentDidMount: function () {
//     if (this.isMounted()) {
//       this.swipe = SwipeJS(ReactDOM.findDOMNode(this), this.props);
//     }
//   },
//
//   componentDidUpdate: function () {
