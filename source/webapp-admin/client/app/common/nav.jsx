Cal.Nav = React.createClass({
    ...
    render() {
        ...
        let navList = [
            ...
            {text: "Biling", href: "/adminRegistration", uiClass: "photo"},
            {text: "Email", href: "/adminRegistration", uiClass: "photo"},
            {text: "Report", href: "/adminRegistration", uiClass: "photo"},
