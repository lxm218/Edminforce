    ...
    return <div className="padding">
      ...
      <RC.Form ref="myForm" onSubmit={this.formSubmit}>
        ...
        <RC.Input
          ...
          size="normal" label="Full Name" />
        <RC.Select
          options={["Apples","Bananas","Oranges","Watermelons","Pears"]}
          name="favFruit" value="Oranges"
          size="normal" label="Favourite Fruit" />
        <RC.Button size="normal" name="button" text="Submit" />
      ...
      <RC.Input
        ...
        size="normal" value="Hello World" label="Type Here" />
      <RC.Select
        ref="form2Select"
        ...
        size="normal" value="Donkey" label="Change This" />
