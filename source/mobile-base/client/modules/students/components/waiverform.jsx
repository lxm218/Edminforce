...
EdminForce.Components.Waiverform = class extends RC.CSS {
    ...
    onSave() {
        ...
        if (!validSignedDate) {
            this.setState({
                    signedDateErrorText: "Please type correct signedDate, mm/dd/yyyy"
                });
            return;
        }
        ...
        return (
            <div>
                <div style={{paddingLeft:7}}>
                    <h2 style={{"text-align":"center"}}>Waiver and Release from Liability/ Assumption of Risk
                    </h2>
                    <p><span>
...
Photographs: CalColor Academy is granted permission to use group or individual photographs or photo images taken during class for publicity or promotional purposes. I understand that the pictures taken will be used by CalColor Academy only and will not be distributed to other parties. <br /><br/>
                ...
                <RC.Div style={{padding: "20px"}}>
                    ...
                    <RC.Input style={{paddingLeft:6}} id="signedDate" name="signedDate" label="Signed date (mm/dd/yyyy)" value={student.signedDate} onChange={this.onChange} />
                    <RC.Input style={{paddingLeft:6}} id="signedBy" name="signedBy" label="Signed by (Parent/Guardian)" value={student.signedBy} onChange={this.onChange}/>
                </RC.Div>
