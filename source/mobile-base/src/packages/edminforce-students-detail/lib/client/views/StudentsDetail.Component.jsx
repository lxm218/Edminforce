    ...
    EdminForce.Components.MakeupClass = class extends RC.CSSMeteorData {
        ...
        getAvailableMakeupLessons(dataIsReady) {
            ...
            for (let i = 0; i < classes.length; i++) {
                ...
                //let makeupStudents = EdminForce.Collections.classStudent.find({
                //        classID: item._id,
                //        status: schemaConst.registrationStatus[3]       // makeup
                //    }, {
                //        sort: {
                //            lessonDate: 1
                //        }
        ...
        //getAvailableClasses(dataIsReady) {
        //    if (!dataisReady) return [];
        //
        //    let availableClasses = [];
        //
        //    let classes = EdminForce.Collections.class.find({programID: this.programID}).fetch();
        //    let studentAge = moment().diff(new Date(this.studentDOB), 'years')
        //    classes.forEach( (c) => {
        //        // skip current class
        //        if (c._id == this.classID) return;
        //
        //        // check age
        //        if (c.minAgeRequire && studentAge < c.minAgeRequire ||
        //            c.maxAgeRequire && studentAge > c.maxAgeRequire)
        //            return;
        //
        //        // check gender
        //        if (c.genderRequire && c.genderRequire !== 'All' && c.genderRequire != this.studentGender)
        //            return;
        //
        //        // check if there is any available space in the class
        //        //c.maxStudent
        //
        //        let numStudentsInClass = EdminForce.Collections.classStudent.find({classID:c._id, status: {} }).count();
        //    });
        //}
