...
// Descriptive texts of Campaign goals --- Obsolete
...
let editHistorySchema = new SimpleSchema({
  userId: {
    type: String,
    label: "UserID which modified campaign info",
  },
  time: {
    type: Date,
...
let CampaignsSchema = new SimpleSchema([IH.Schema.createdAt, IH.Schema.updatedAt, {
  ...
  editHistory: {
    ...
    label: "UserID of the person who created the campaign",
    optional: true,
    autoValue() {
      let editInfo = {
