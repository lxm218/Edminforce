  ...
  render(){
    ...
    return (
        <tr onClick={this.props.onClick}>
          ...
          <td>{h.nk(user, "emails.0.address")}</td>
          <td>{(user.profile.height || 0).toFixed(2)}</td>
          <td>{(user.profile.weight || 0).toFixed(2)}</td>
...
IH.RC.UserListItem.displayName = "IH.RC.UserListItem"
