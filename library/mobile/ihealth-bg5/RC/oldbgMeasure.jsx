...
IH.RC.BG5Control2 = React.createClass({
  ...
  render: function() {
    ...
    return <div className={"absFull background device-back overflow "+'BG'+headerSpace}>
  ...
  renderConnect() {
    ...
    return <div>
      ...
      <RC.Animate transitionName="slide-up" transitionEnterTimeout={250} transitionLeaveTimeout={250}>
...
IH.RC.MeasureBG = React.createClass({
  ...
  render: function() {
    ...
    return <div className={"absFull bg-white scroll on-top-higher"+deviceType} onClick={this.restartInactiveTimer} id="measuring-bp">
