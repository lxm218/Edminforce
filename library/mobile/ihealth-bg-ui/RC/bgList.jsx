...
IH.Device.BGListItem = React.createClass({
  ...
  render() {
    ...
    return <IH.Device.ListItem header={this.props.showDate ? moment(bgVal.MDate).format("ddd, MMM Do, YYYY") : false} zoneColor={zoneColor} alt={this.props.order%2} theme="BG">
