 ...
 *
*/
let SwipeJS = function(container, argOptions) {
  // "use strict";

  // utilities
  var options = Object.assign({}, argOptions);
...
RC.Swipe = class extends RC.CSS {
  // https://github.com/thebird/Swipe#config-options

  componentDidMount() {
    super.componentDidMount && super.componentDidMount();
    this.swipe = SwipeJS(ReactDOM.findDOMNode(this.refs.swipeJS), this.props);
  }
  ...
  shouldComponentUpdate(nextProps) {
    ...
    return this.props.slideToIndex !== nextProps.slideToIndex
      || !_.isFunction(this.props.shouldUpdate) || this.props.shouldUpdate(nextProps)
  }
  ...
  render() {
    ...
    return <div {... this.props} style={styles.area} ref="swipeJS">
      <div style={styles.wrapper}>
        {this.renderChildren()}
      </div>
      {this.props.outerContent}
    </div>
  }

  baseStyles(np, ns) {
    let top = 0, bot = 0;
    switch(this.props.gNav) {
      case "top":
        top += 50
        break;
      case "bot":
    ...
    return {
      area: {
        ...
        top: top, bottom: bot, left: 0, right: 0,
        backgroundColor: this.color.get("hex"), color: this.color.get("realText")
      },
      container: {
        overflow: 'hidden',
        visibility: 'hidden',
...
RC.Swipe.propTypes = Object.assign({}, RC.Swipe.propTypes, {
