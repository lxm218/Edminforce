...
App.Layout.ComponentsPage = React.createClass({
  displayName: "Mobile Components Page",
  ...
  renderContent() {
    ...
    return <div>
      <RC.Header style={h.assignClone( gradient, {paddingBottom: 78, paddingTop: "8%"})} bgColor={color}>
      ...
      !!content
      ?
      <RC.GridBoxArea theme={["content","padding-l","padding-r","padding-b"]}>
        <RC.GridBoxItem theme={["padding-r","padding-t"]}>
          <RC.Tabs initialTab={0} theme="folder" bgColor="light" ref="paneTabs" style={{marginBottom: 12}}>
            {
