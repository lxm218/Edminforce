  ...
  class extends RC.Code {
    ...
    renderExample() {
      return (
       <RC.Timeline>
        <RC.Journal
          theme="heading" title="Bruno's Birthday"
          uiClass="map"
        />
        ...
        <RC.Journal
          theme="heading" title={new Date("Wed May 20 2015 11:14:35 GMT-0700 (PDT)")}
          uiClass="coffee" uiBgColor="brand2"
        />
        <RC.Journal title="About August" uiBgColor="brand">
          August is the 8th month of the year. August is one month away from Autumn.
        </RC.Journal>
        <RC.Journal title="About December" uiBgColor="brand2">
        ...
        <RC.Journal title="About January" uiBgColor="brand3">
