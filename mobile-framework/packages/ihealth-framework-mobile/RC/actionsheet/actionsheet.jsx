...
RC.ActionSheet = React.createClass({
  ...
  renderBackDrop() {
    return <RC.Animate transitionName="fade">
      {
  ...
  renderActionSheet() {
    ...
    return <RC.Animate transitionName="from-bottom">
      {
      this.state.isHidden ? null :
      <div {... this.props} style={styles.canvas} onClick={this.stopPropagation}>
  ...
  render() {
    ...
    // return <div {... this.props} style={styles.canvas} onClick={this.stopPropagation}>
    return <div>
      {this.renderBackDrop()}
