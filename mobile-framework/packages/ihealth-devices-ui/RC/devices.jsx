...
DeviceRC.Prepare = React.createClass({
  ...
  render: function() {
    ...
    return <div className={"abs-full background device-back overflow "+deviceName+headerSpace}>
...
DeviceRC.BlurryBackground = React.createClass({
  render: function() {
    ...
    return <div className={"abs-full device-back-blur background transition-slower" + (notblurBack ? " invis" : "")} />
