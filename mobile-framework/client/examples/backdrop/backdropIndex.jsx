  ...
  render() {
    return <div>
      <RC.List>
        ...
        <RC.Item theme="icons" uiClass="tags" uiColor="brand1" onClick={this.backdrop1}>Backdrop with Message</RC.Item>
        <RC.Item theme="icons" uiClass="tags" uiColor="brand2" onClick={this.backdrop2}>Backdrop with Close Button</RC.Item>
        <RC.Item theme="icons" uiClass="tags" uiColor="brand3" onClick={this.backdrop3}>Backdrop with Actionsheets</RC.Item>
