...
App.Form_Handling = React.createClass({
  ...
  render() {
    ...
    return <div>
      ...
      <RC.ItemDivider>Form Submit</RC.ItemDivider>
      ...
      <RC.ItemDivider>Form Change</RC.ItemDivider>
      ...
      <RC.ItemDivider>Error Handler</RC.ItemDivider>
      <RC.Div theme="padding">
        <RC.Input
          theme="stacked-label"
          validations={this.form3errorHandler}
