...
let stComposition = function(Component) {
  const Composition = React.createClass({
    ...
    render() {
      ...
      let canvasInnerStyle = this.state.isHover ? { padding: "0 0 0 200px" } : {}
      let uiColor = this.state.isHover ? "brand1" : null

      return <Component {... this.props} onMouseOver={this.mouseOver} onMouseOut={this.mouseOut} canvasInnerStyle={canvasInnerStyle} uiColor={uiColor}>
        {this.props.children}
      </Component>
    }
  })
