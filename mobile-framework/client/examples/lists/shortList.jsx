  ...
  render() {
    ...
    return <RC.Div bgColor="brand3Light" theme="full">
      <RC.List theme="inset">
        ...
        <RC.ItemDivider theme="short">A</RC.ItemDivider>
        {
        ...
        <RC.ItemDivider theme="short">B</RC.ItemDivider>
        {
        ...
        <RC.ItemDivider theme="short">C</RC.ItemDivider>
        {
        ...
        <RC.ItemDivider theme="short">D</RC.ItemDivider>
        {
