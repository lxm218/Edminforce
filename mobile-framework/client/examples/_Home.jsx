...
App.Home = React.createClass({
  loop(arr,brand) {
    return arr.map(function(item,n){
      ...
      return <RC.ItemIcons {... _.omit(item, ["value"])} key={n}>
        {item.value}
      </RC.ItemIcons>
    })
  },
  ...
  render() {
    ...
    let Commons = [
      ...
      { value: "DatePicker", href: "/datepicker", uiClass: "check-circle-o" },
    ]
